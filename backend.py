...
def research_node(state: State) -> dict:
    ...
    # Handle models that return None
    if pack is None or pack.evidence is None:
        return {"evidence": []}
...
# Hugging Face FLUX.1-dev Version
# ============================================================
...
def merge_content(state: State) -> dict:
    ...
    print("=" * 50)
    print("SECTIONS RECEIVED:", len(state["sections"]))
    ...
    print("MERGED LENGTH:", len(merged_md))
...
- Prefer technical diagrams instead of decorative art.
...
# ------------------------------------------------------------
# Hugging Face Image Generation (FLUX.1-dev)
# ------------------------------------------------------------
